...
obj.Attention = "Chúc mừng bạn đã nhận được siêu dữ liệu! Vui lòng không bán hoặc chia sẻ với người khác.！";
var ddgksf2013 = { is_sandbox: !1, ownership_type: "PURCHASED", billing_issues_detected_at: null, period_type: "normal", expires_date: "2099-12-18T01:04:17Z", grace_period_expires_date: null, unsubscribe_detected_at: null, original_purchase_date: "2022-09-08T01:04:18Z", purchase_date: "2024-11-11T01:04:17Z", store: "app_store" },
    ddgksf2021 = { grace_period_expires_date: null, purchase_date: "2024-11-11T01:04:17Z", product_identifier: "com.quocchien.premium.yearly", expires_date: "2099-12-18T01:04:17Z" };
const match = Object.keys(mapping).find(e => ua.includes(e));
if (match) { let [e, s] = mapping[match];
    s ? (ddgksf2021.product_identifier = s, obj.subscriber.subscriptions[s] = ddgksf2013) : obj.subscriber.subscriptions["com.quocchien.premium.yearly"] = ddgksf2013, obj.subscriber.entitlements[e] = ddgksf2021 } else obj.subscriber.subscriptions["com.quocchien.premium.yearly"] = ddgksf2013, obj.subscriber.entitlements.pro = ddgksf2021, console.log('Hoạt động thành công 🎉🎉🎉');
